...
export default function ACSpeakers():React.ReactElement {
    ...
    return(
         ...
         <div className='speaker-card h-full  w-[300px] sm:w-full md:max-w-[300px] overflow-hidden relative'>
                 ...
                 <div className='speaker-img-container w-full h-[65%]  relative'>
                    <div className='speaker-img-nonredshade flex justify-center items-center text-center text-white p-[5%]'>
...
<div className='w-full flex justify-center mt-[15%] md:mt-[10%]'>
